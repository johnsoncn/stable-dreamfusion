...
with gr.Blocks(css=".gradio-container {max-width: 1024px; margin: auto;}") as demo:
    ...
    with gr.Accordion("输入描述尽可能具体，点我查看描述样例！" ,open=False):
        gr.Markdown("【a steam engine train, high resolution】\n"
                    ...
                    "【a toy robot】\n"
                    "【a ripe strawberry】\n"
                    "【 very beautiful tiny human heart organic sculpture made of copper wire and threaded pipes, very intricate, curved, Studio lighting, high resolution】")
